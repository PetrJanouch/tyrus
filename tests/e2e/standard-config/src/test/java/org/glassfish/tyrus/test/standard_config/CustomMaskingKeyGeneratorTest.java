...
public class CustomMaskingKeyGeneratorTest extends TestContainer {
    ...
    public void testCustomMaskingKeyGenerator() {
        ...
        try {
            ...
            final CountDownLatch generatorLatch = new CountDownLatch(messageCount);
            ...
            assertTrue(generatorLatch.await(5, TimeUnit.SECONDS));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        } finally {
    ...
    @ServerEndpoint("/customMaskingKeyTest")
