...
public class OpenSessionsTest extends TestContainer {
    ...
    private void test(boolean monitorOnSessionLevel) {
        ...
        try {
            ...
            ApplicationEventListener applicationEventListener = new TestApplicationEventListener(new ApplicationJmx(monitorOnSessionLevel), sessionOpenedLatch, sessionClosedLatch, null);
