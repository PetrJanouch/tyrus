...
public class EndpointPropertiesTest extends TestContainer {
    ...
    public void testJmx() {
        ...
        try {
            ...
            ApplicationEventListener application1EventListener = new ApplicationJmx(true);
            ...
            server2Properties.put(ApplicationEventListener.APPLICATION_EVENT_LISTENER, new ApplicationJmx(true));
