...
/**
 * Tests that statistics about sent snd received messages are collected correctly on application level.
 *
...
public class MessageStatisticsTest extends TestContainer {
    ...
    public void test(boolean monitorOnSessionLevel) {
        ...
        try {
            ...
            ApplicationEventListener application1EventListener = new TestApplicationEventListener(new ApplicationJmx(monitorOnSessionLevel), null, null, latch);
            ...
            ApplicationEventListener application2EventListener = new TestApplicationEventListener(new ApplicationJmx(monitorOnSessionLevel), null, null, latch);
