...
/**
 * Tests that statistics about sent snd received messages are collected correctly.
 *
...
public class MessageStatisticsTest extends TestContainer {
    ...
    public static class DummyClientEndpoint {
        ...
        /*
        Latch used to ensure all messages were delivered on the server, before the statistics are checked
        For every pong, text and binary message sent, 2 are received. For every ping message sent, 1 pong is received.
        Therefore the expected number of received messages is 2 * 6 + 2 * 6 + 2 * 6 + 6 = 42
         */
        final static CountDownLatch latch = new CountDownLatch(42);
    ...
    public void test() {
        ...
        try {
            ...
            Session session1 = client.connectToServer(DummyClientEndpoint.class, new URI("ws", null, "localhost", 8025, "/jmxTestApp/jmxStatisticsServerEndpoint1", null, null));
            Session session2 = client.connectToServer(DummyClientEndpoint.class, new URI("ws", null, "localhost", 8025, "/jmxTestApp/jmxStatisticsServerEndpoint2", null, null));
            Session session3 = client.connectToServer(DummyClientEndpoint.class, new URI("ws", null, "localhost", 8025, "/jmxTestApp/jmxStatisticsServerEndpoint2", null, null));
            Session session4 = client.connectToServer(DummyClientEndpoint.class, new URI("ws", null, "localhost", 8026, "/jmxTestApp2/jmxStatisticsServerEndpoint2", null, null));
            Session session5 = client.connectToServer(DummyClientEndpoint.class, new URI("ws", null, "localhost", 8026, "/jmxTestApp2/jmxStatisticsServerEndpoint3", null, null));
            Session session6 = client.connectToServer(DummyClientEndpoint.class, new URI("ws", null, "localhost", 8026, "/jmxTestApp2/jmxStatisticsServerEndpoint3", null, null));
            ...
            assertTrue(DummyClientEndpoint.latch.await(1, TimeUnit.SECONDS));
    ...
    private void checkApplicationStatisticsCollectedCorrectly(String applicationName, int openSessionsCount, int sentMessagesCount, int sentMessagesSize,
        ...
        String fullApplicationMxBeanName = "org.glassfish.tyrus:type=application,appName=" + applicationName;
        try {
            ...
            assertEquals(openSessionsCount, applicationBean.getMaxOpenSessionsCount());
