 ...
 * Creates and registers @MessageStatisticsMXBean MXBean for text, binary control and all messages which expose these statistics.
 *
 * @author Petr Janouch (petr.janouch at oracle.com)
 * @see org.glassfish.tyrus.core.monitoring.MessageEventListener
 */
class SessionJmx implements MessageListener {
    ...
    SessionJmx(String applicationName, String endpointPath, String sessionId, MessageListener messageListener) {
        this.applicationName = applicationName;
        this.endpointPath = endpointPath;
        this.sessionId = sessionId;
        this.messageListener = messageListener;

        MessageStatisticsMXBean sessionMXBean = new MessageStatisticsMXBeanImpl(new AggregatedMessageStatistics(sentTextMessageStatistics, sentBinaryMessageStatistics, sentControlMessageStatistics), new AggregatedMessageStatistics(receivedTextMessageStatistics, receivedBinaryMessageStatistics, receivedControlMessageStatistics));
