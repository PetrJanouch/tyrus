...
/**
 * Publishes Tyrus MXBeans, so that they are accessible from MBean clients e.g. jConsole.
 *
...
class MBeanPublisher {
    ...
    private static final String APPLICATION_NAME_BASE = DOMAIN + ":type=application,appName=";
    ...
    /**
     * Registers {@link org.glassfish.tyrus.ext.monitoring.jmx.ApplicationMXBean} and MXBeans exposing statistics
    ...
    static void registerApplicationMXBeans(String applicationName, ApplicationMXBean applicationMXBean,
                                           MessagesStatisticsMXBean textMessageStatisticsMXBean,
                                           MessagesStatisticsMXBean binaryMessageStatisticsMXBean,
                                           MessagesStatisticsMXBean controlMessageStatisticsMXBean) {
    ...
    /**
     * Registers {@link org.glassfish.tyrus.ext.monitoring.jmx.EndpointMXBean} and MXBeans exposing statistics.
    ...
    /**
     * Registers MXBeans exposing statistics about text, binary, control and total messages sent and received by the session.
     *
     * @param applicationName                application name.
     * @param endpointPath                   endpoint path.
     ...
     */
    static void registerSessionMXBeans(String applicationName, String endpointPath, String sessionId, MessagesStatisticsMXBean sessionMXBean,
                                       MessagesStatisticsMXBean textMessageStatisticsMXBean,
                                       MessagesStatisticsMXBean binaryMessageStatisticsMXBean,
                                       MessagesStatisticsMXBean controlMessageStatisticsMXBean) {
    ...
    private static void registerStatisticsMXBeans(String nameBase, MessagesStatisticsMXBean nodeMXBean, MessagesStatisticsMXBean textMessageStatisticsMXBean,
                                                  MessagesStatisticsMXBean binaryMessageStatisticsMXBean,
                                                  MessagesStatisticsMXBean controlMessageStatisticsMXBean) {
    ...
    /**
     * Unregisters an MXBeans of the given application including all the endpoint and sessions MXBeans.
     *
     * @param applicationName application name.
     */
    ...
    /**
     * Unregisters an MXBeans of the given endpoint including all the sessions MXBeans.
     *
     * @param applicationName application name.
     * @param endpointPath    endpoint path.
     */
    ...
    /**
     * Unregisters an MXBeans of the given session.
     *
     * @param applicationName application name.
     * @param endpointPath    endpoint path.
     * @param sessionId       session ID.
