...
public final class GrizzlyClientProperties {
     ...
     * Value is expected to be instance of {@link org.glassfish.grizzly.threadpool.ThreadPoolConfig}, can be {@code null} (it won't be used).
     * <p/>
     * If both {@link #SELECTOR_THREAD_POOL_CONFIG} nad  {@link org.glassfish.tyrus.client.ClientProperties#SELECTOR_THREAD_POOL_CONFIG}
     * are set, configuration set in {@link #SELECTOR_THREAD_POOL_CONFIG} will be used.
     */
